          ...
          "<div class='dialogContainer'>" +
            "<div class='dialogContent'>" +
              ...
              "<div class='dialogContentBody'><form>" +
                ...
                "</div>" +
                "<div class='input-field'>" +
                  "<input type='text' value='Anime could not be detected' disabled id='qmal-update-anime-name' name='qmal-update-anime-name' style='width:auto;overflow:hidden'>" +
                  "<label for='qmal-update-anime-name' class='active'>Anime Name</label>" +
                  "<a class='qmal-button' id='qmal-update-name-not-this' style='float:right;margin-bottom:15px;display:inline;' href='#'><div class='buttonFlat' fit>Not the Correct Anime?</div></a>" +
                "</div>" +
                "<div class='input-field'>" +
